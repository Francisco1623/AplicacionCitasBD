...
<form method='POST'>
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      ...
      <select id="user" name="user" class="custom-select" disabled>
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="date" name="date" type="text" class="form-control" value=<?= $appoimentId['fecha'] ?> disabled>
    </div>
  </div>
  <div class="form-group row">
    <label for="time" class="col-4 col-form-label">Hora</label> 
    <div class="col-8">
      <input id="time" name="time" type="text" class="form-control" value=<?= $appoimentId['hora'] ?> disabled>
    </div>
  </div> 
  <div class="form-group row">
